...
void _askroaConfigWarn(String msg) {
  // ignore: avoid_print
  debugPrint('[Askroa] CONFIG WARNING: $msg');
}
...
class DefaultFirebaseOptions {
  ...
  static FirebaseOptions get android {
    ...
    if (apiKey.isEmpty || appId.isEmpty || messagingSenderId.isEmpty || projectId.isEmpty) {
      final msg = '[Askroa] CRITICAL: Firebase Android config missing. '
          'Set FIREBASE_ANDROID_API_KEY, FIREBASE_ANDROID_APP_ID, '
          'FIREBASE_MESSAGING_SENDER_ID, FIREBASE_PROJECT_ID via --dart-define.';
      debugPrint(msg);
      assert(() {
        _askroaConfigWarn(msg);
        return true;
      }());
    }

    return FirebaseOptions(
      apiKey:             apiKey.isNotEmpty ? apiKey : 'MISSING_ANDROID_API_KEY',
      appId:              appId.isNotEmpty ? appId : 'MISSING_ANDROID_APP_ID',
      messagingSenderId:  messagingSenderId.isNotEmpty ? messagingSenderId : 'MISSING_SENDER_ID',
      projectId:          projectId.isNotEmpty ? projectId : 'MISSING_PROJECT_ID',
      storageBucket:      storageBucket.isNotEmpty ? storageBucket
                          : (projectId.isNotEmpty ? '$projectId.appspot.com' : 'MISSING_BUCKET'),
    );
  }
  ...
  static FirebaseOptions get ios {
    ...
    return FirebaseOptions(
      apiKey:             apiKey.isNotEmpty ? apiKey : 'MISSING_IOS_API_KEY',
      appId:              appId.isNotEmpty ? appId : 'MISSING_IOS_APP_ID',
      messagingSenderId:  messagingSenderId.isNotEmpty ? messagingSenderId : 'MISSING_SENDER_ID',
      projectId:          projectId.isNotEmpty ? projectId : 'MISSING_PROJECT_ID',
      storageBucket:      storageBucket.isNotEmpty ? storageBucket
                          : (projectId.isNotEmpty ? '$projectId.appspot.com' : 'MISSING_BUCKET'),
      iosClientId:        iosClientId.isNotEmpty ? iosClientId : 'MISSING_IOS_CLIENT_ID',
      iosBundleId:        iosBundleId.isNotEmpty ? iosBundleId : 'MISSING_IOS_BUNDLE_ID',
    );
  }
  ...
  static FirebaseOptions get web {
    ...
    return FirebaseOptions(
      apiKey:             apiKey.isNotEmpty ? apiKey : 'MISSING_WEB_API_KEY',
      appId:              appId.isNotEmpty ? appId : 'MISSING_WEB_APP_ID',
      messagingSenderId:  messagingSenderId.isNotEmpty ? messagingSenderId : 'MISSING_SENDER_ID',
      projectId:          projectId.isNotEmpty ? projectId : 'MISSING_PROJECT_ID',
      storageBucket:      storageBucket.isNotEmpty ? storageBucket
                          : (projectId.isNotEmpty ? '$projectId.appspot.com' : 'MISSING_BUCKET'),
      authDomain:         authDomain.isNotEmpty ? authDomain : 'MISSING_AUTH_DOMAIN',
    );
  }
  ...
  static FirebaseOptions get windows {
    ...
    return FirebaseOptions(
      apiKey:             apiKey.isNotEmpty ? apiKey : 'MISSING_WINDOWS_API_KEY',
      appId:              appId.isNotEmpty ? appId : 'MISSING_WINDOWS_APP_ID',
      messagingSenderId:  messagingSenderId.isNotEmpty ? messagingSenderId : 'MISSING_SENDER_ID',
      projectId:          projectId.isNotEmpty ? projectId : 'MISSING_PROJECT_ID',
      storageBucket:      storageBucket.isNotEmpty ? storageBucket
                          : (projectId.isNotEmpty ? '$projectId.appspot.com' : 'MISSING_BUCKET'),
  ...
  static FirebaseOptions get macos {
    ...
    return FirebaseOptions(
      apiKey:             apiKey.isNotEmpty ? apiKey : 'MISSING_MACOS_API_KEY',
      appId:              appId.isNotEmpty ? appId : 'MISSING_MACOS_APP_ID',
      messagingSenderId:  messagingSenderId.isNotEmpty ? messagingSenderId : 'MISSING_SENDER_ID',
      projectId:          projectId.isNotEmpty ? projectId : 'MISSING_PROJECT_ID',
      storageBucket:      storageBucket.isNotEmpty ? storageBucket
                          : (projectId.isNotEmpty ? '$projectId.appspot.com' : 'MISSING_BUCKET'),
  ...
  static FirebaseOptions get linux {
    ...
    return FirebaseOptions(
      apiKey:             apiKey.isNotEmpty ? apiKey : 'MISSING_LINUX_API_KEY',
      appId:              appId.isNotEmpty ? appId : 'MISSING_LINUX_APP_ID',
      messagingSenderId:  messagingSenderId.isNotEmpty ? messagingSenderId : 'MISSING_SENDER_ID',
      projectId:          projectId.isNotEmpty ? projectId : 'MISSING_PROJECT_ID',
      storageBucket:      storageBucket.isNotEmpty ? storageBucket
                          : (projectId.isNotEmpty ? '$projectId.appspot.com' : 'MISSING_BUCKET'),
...
const String newAppIconUrl = 'https://ik.imagekit.io/8bexlj4gl0/Picsart_26-03-01_09-26-26-240.jpg';
...
class AppAssets {
  ...
  static const String liveAIicon = 'assets/icons/live_ai_icon';
...
class EnvironmentConfig {
  ...
  void _validateConfig() {
    ...
    if (_backendBaseUrl.isEmpty) {
      throw Exception('Backend URL not configured - use dart-define BACKEND_BASE_URL');
    }
...
class ProductionLogger {
  ...
  static const String _hashSalt = 'askroa_salt_v1_2024';
  ...
  void _sendToSentry(String message, SentryLevel level, dynamic error, StackTrace? stackTrace) {
    if (_isProduction) {
      try {
        ...
        if (kDebugMode) { _logger.d('Sentry internal error suppressed'); }
      }
    }
  }
...
class ProductionEncryptionService {
  ...
  final String _keyStorageKey = 'askroa_encryption_key_v4';
  final String _backupKeyStorageKey = 'askroa_encryption_key_v4_backup';
  bool _isInitialized = false;
  ...
  Future<void> initialize() async {
    ...
    try {
      ...
      _aesKey = encrypt.Key.fromBase64(existingKey);
      _encrypter = encrypt.Encrypter(
        encrypt.AES(_aesKey, mode: encrypt.AESMode.gcm),
      );
      ...
      _logger.e('Failed to initialize encryption service', error: e, stackTrace: stack);
      rethrow;
    }
  }

  void _startKeyRotationTimer() {
    _keyRotationTimer = Timer.periodic(const Duration(days: 90), (timer) {
      rotateEncryptionKey();
    });
    _ivCacheCleanupTimer = Timer.periodic(const Duration(hours: 1), (_) {
      if (_ivCache.length > 500) _ivCache.clear();
    });
  }
  ...
  void restartKeyRotationTimer() {
    ...
    _startKeyRotationTimer();
    _logger.d('Key rotation timer restarted');
  }
  ...
  String encrypt(String plainText) {
    try {
      ...
      _logger.e('Encryption failed', error: e);
  ...
  Future<String> decrypt(String encryptedText) async {
    try {
      ...
      if (parts.length != 2) {
        _logger.w('Invalid encrypted format, trying backup decryption');
        return await _decryptWithBackupKey(encryptedText);
      }
      ...
      try {
        ...
        _logger.w('Decryption with primary key failed, trying backup', error: e);
        return await _decryptWithBackupKey(encryptedText);
      }
    } catch (e) {
  ...
  Future<String> _decryptWithBackupKey(String encryptedText) async {
    final keysToTry = [
      _backupKeyStorageKey,
      '${_backupKeyStorageKey}_prev',
    ];
    for (final keyName in keysToTry) {
      try {
        final backupKeyString = await _secureStorage.read(key: keyName);
        if (backupKeyString == null) continue;
        final backupKey = encrypt.Key.fromBase64(backupKeyString);
        final backupEncrypter = encrypt.Encrypter(encrypt.AES(backupKey));
        final parts = encryptedText.split(':');
        if (parts.length != 2) continue;
        final iv = encrypt.IV.fromBase64(parts[0]);
        final encrypted = encrypt.Encrypted.fromBase64(parts[1]);
        final decrypted = backupEncrypter.decrypt(encrypted, iv: iv);
        _logger.i('Successfully decrypted with backup key ($keyName)');
        return decrypted;
      } catch (_) {
        continue;
      }
    }
    _logger.e('All backup decryption attempts failed');
    return '[DECRYPTION_FAILED]';
  }
  ...
  Future<Map<String, dynamic>> encryptData(Map<String, dynamic> data) async {
    try {
      ...
      return {
        ...
        'encryption_version': 'aes256',
        'timestamp': DateTime.now().toUtc().toIso8601String(),
      };
    } catch (e) {
      _logger.e('Data encryption failed', error: e);
      rethrow;
    }
  }
  ...
  Future<Map<String, dynamic>> decryptData(String encryptedData) async {
    try {
      ...
      _logger.e('Data decryption failed', error: e);
      rethrow;
    }
  }
  ...
  Future<void> rotateEncryptionKey() async {
    ...
    try {
      _logger.i('[Encryption] Starting AES-256-GCM key rotation');

      final secureRandom = Random.secure();
      final newKeyBytes = List<int>.generate(32, (_) => secureRandom.nextInt(256));
      final newKeyString = base64.encode(newKeyBytes);
      final newKey = encrypt.Key.fromBase64(newKeyString);

      final oldKeyString = await _secureStorage.read(key: _keyStorageKey);
      if (oldKeyString != null) {
        ...
        _logger.d('[Encryption] Old key backed up to secure storage');
      }
      ...
      await prefs.setString(
        'askroa_key_rotation_ts',
        DateTime.now().toUtc().toIso8601String(),
      );

      _logger.i('[Encryption] Key rotation complete. Next rotation in 90 days.');

      _backupDeletionTimer?.cancel();
      _backupDeletionTimer = Timer(const Duration(days: 30), () async {
        final veryOldKey = await _secureStorage.read(key: '${_backupKeyStorageKey}_prev');
        if (veryOldKey != null) {
          await _secureStorage.delete(key: '${_backupKeyStorageKey}_prev');
        }
        final currentBackup = await _secureStorage.read(key: _backupKeyStorageKey);
        if (currentBackup != null) {
          await _secureStorage.write(
            key: '${_backupKeyStorageKey}_prev',
            value: currentBackup,
            aOptions: const AndroidOptions(encryptedSharedPreferences: true),
            iOptions: const IOSOptions(accessibility: KeychainAccessibility.first_unlock),
          );
      ...
      _logger.e('Key rotation failed', error: e, stackTrace: stack);
    } finally {
      _keyMutex.release();
    }
  }
...
extension ChatE2EE on ProductionEncryptionService {
  Future<String> _getOrCreateSessionKey(String sessionId) async {
    const ss = FlutterSecureStorage(
      aOptions: AndroidOptions(encryptedSharedPreferences: true),
      iOptions: IOSOptions(accessibility: KeychainAccessibility.first_unlock_this_device),
    );
    final storageKey = 'askroa_chat_key_$sessionId';
    String? existing = await ss.read(key: storageKey);
    if (existing != null) return existing;
    final secureRandom = Random.secure();
    final keyBytes = List<int>.generate(32, (_) => secureRandom.nextInt(256));
    final newKey = base64Url.encode(keyBytes);
    await ss.write(key: storageKey, value: newKey);
    return newKey;
  }

  Future<String> encryptChatMessage(String sessionId, String plainText) async {
    try {
      final keyStr = await _getOrCreateSessionKey(sessionId);
      ...
      throw Exception('[E2EE] Chat message encryption failed: $e');
    }
  }
  ...
  Future<String> decryptChatMessage(String sessionId, String cipherText) async {
    try {
      ...
      if (parts.length != 2) return '[E2EE_DECRYPT_FAILED]';
      final iv = encrypt.IV.fromBase64(parts[0]);
  ...
  Future<void> deleteSessionKey(String sessionId) async {
    ...
    await ss.delete(key: 'askroa_chat_key_$sessionId');
  }
}
...
class WebSocketService {
  ...
  void onAppResumed() {
    if (!_isConnected.value && !_isDisposed) {
      _reconnectAttempts = 0;
      _scheduleReconnect();
    }
    if (!_isWakeWordConnected.value && !_isDisposed) {
      _wakeWordReconnectAttempts = 0;
      _scheduleWakeWordReconnect();
    }
  }
...
class RateLimitingService {
  ...
  static const Map<String, int> _dailyQuotas = {
    'free': 5,
    'monthly': 100,
    'half_year': 200,
    'yearly': 1000,
...
class SecurityArchitecture {
  ...
  static final List<String> _pinnedCertificates = [
    const String.fromEnvironment(
      ...
      defaultValue: 'sha256/47DEQpj8HBSa+/TImW+5JCeuQeRkm5NMpJWZG3hSuFU=',
    ),
  ...
  Future<void> _initializeEncryption() async {
    try {
      String? keyString = await _secureStorage.read(key: 'aes_key_256_gcm_v2');
      ...
      _aesKey = encrypt.Key.fromBase64(keyString);
      _encrypter = encrypt.Encrypter(
        encrypt.AES(_aesKey, mode: encrypt.AESMode.gcm),
      );

      _logger.i('Encryption initialized with AES-256-GCM (authenticated)');
    } catch (e, stack) {
      _logger.e('Encryption initialization failed', error: e, stackTrace: stack);
      rethrow;
    }
  }
  ...
  Future<String> decrypt(String encryptedText) async {
    try {
      ...
      try {
        ...
        _logger.w('Primary decryption failed, trying backup key', error: e);
        final backupKeyString = await _secureStorage.read(key: 'askroa_encryption_key_v4_backup');
        if (backupKeyString == null) {
          throw Exception('No backup key available');
        }
        final backupKey = encrypt.Key.fromBase64(backupKeyString);
        final backupEncrypter = encrypt.Encrypter(encrypt.AES(backupKey));
        final decrypted = backupEncrypter.decrypt(encrypted, iv: iv);
        _logger.i('Successfully decrypted with backup key');
        return decrypted;
      }
    } catch (e) {
      _logger.e('Decryption failed', error: e);
...
class GlobalUserHandler {
  ...
  Future<void> initialize() async {
    ...
    try {
      ...
      _logger.e('Failed to initialize user handler', error: e, stackTrace: stack);
      if (!kIsWeb && (Platform.isAndroid || Platform.isIOS)) {
        try {
  ...
  Future<void> _deleteAllChatSessionKeys(FlutterSecureStorage ss) async {
    try {
  ...
  void dispose() {
    _isDisposed = true;
    _dailyResetTimer?.cancel();
    _rateLimitCleanupTimer?.cancel(); // FIX: Cancel cleanup timer on dispose
...
class PerformanceOptimizer {
  ...
  final List<int> _frameRenderTimes = [];
...
class DatabaseService {
  ...
  Future<void> initialize() async {
    ...
    try {
      await _performance.measureOperation('db_initialize', () async {
        _driftIsolate = await DriftIsolate.spawn(() => _openConnection());
  ...
  Future<void> restoreFromBackup(File backupFile) async {
    try {
      ...
      final decryptedBase64 = await encryption.decrypt(encrypted);
      
      if (decryptedBase64 == '[DECRYPTION_FAILED]') {
        throw Exception('Backup decryption failed');
      }
      
      final bytes = base64Decode(decryptedBase64);
      final dbPath = await _getDatabasePath();
      
      await _database.close();
      if (_driftIsolate != null) {
        await _driftIsolate!.shutdown();
        _driftIsolate = null;
      }
      ...
      _logger.i('Database restored from backup (isolate re-spawned)');
    } catch (e, stack) {
  ...
  Future<Map<String, dynamic>> exportUserData(String userId) async {
    try {
      ...
      final messages = await (_database.select(_database.localChatMessages)
        ..where((tbl) => tbl.sessionId.like('%$userId%'))).get();
      final sessions = await _database.getChatSessions();
    ...
    return await _performance.measureOperation('api_${request.endpoint.replaceAll('/', '_')}', () async {
      ...
      try {
        ...
        final options = Options(
          ...
          sendTimeout: request.timeout ?? _defaultTimeout,
          receiveTimeout: request.timeout ?? _defaultTimeout,
        );
...
class CertificatePinningService {
  ...
  Future<void> initialize() async {
    ...
    if (kDebugMode) {
      _logger.d(
        'Certificate pinning initialized with ${_pinnedCertificates.length} pins. '
        'Set CERTIFICATE_PIN_PRIMARY and CERTIFICATE_PIN_BACKUP via --dart-define.',
      );
    }
...
class BackgroundSyncOrchestrator {
  ...
  void _startNetworkMonitoring() {
    Timer.periodic(_networkCheckInterval, (timer) async {
      if (!_isDisposed && _connectivity.isConnected.value && !_isSyncing) {
...
class InAppPurchaseService {
  ...
  Future<void> initialize() async {
    ...
    try {
      ...
      purchaseStream.listen(_listenToPurchaseUpdated);
  ...
  void _enqueueForRetry(PurchaseDetails purchase) {
    ...
    if (!alreadyQueued) {
      ...
      _logger.w('[IAP] Purchase queued for retry: ${purchase.productID}');
    }
      ...
      if (userData != null) {
        ...
        if (decrypted != '[DECRYPTION_FAILED]') {
          ...
          if (productId.contains('monthly')) {
            plan = 'monthly';
          } else if (productId.contains('half_year')) {
            plan = 'half_year';
          ...
          userJson['plan'] = plan;
          userJson['subscription_expiry'] = DateTime.now()
          ...
          if (encryptedAccessToken != null) {
            ...
            if (token != '[DECRYPTION_FAILED]') {
              await _syncSubscriptionWithServer(token, plan);
            }
          }

          _logger.i('Product delivered: $productId, plan: $plan');
        }
      }
    } catch (e, stack) {
      _logger.e('Failed to deliver product', error: e, stackTrace: stack);
    }
  }
...
class GlobalCrashRecovery {
  ...
  Future<void> initialize() async {
    ...
    if (envConfig.sentryDsn.isNotEmpty && !kIsWeb && (Platform.isAndroid || Platform.isIOS)) {
      try {
        await SentryFlutter.init(
          (options) {
            ...
            options.enableStickyFrames = true;
        ...
        _logger.d('Sentry initialization failed', error: e);
      }
    }
  ...
  void _backgroundCallbackDispatcher() {
    Workmanager().executeTask((task, inputData) async {
      try {
        ...
        ProductionLogger(isProduction: true).e('Background task failed: $task', error: e, stackTrace: stack);
        return false;
      }
    });
  }
...
class _GlobalErrorBoundaryState extends State<GlobalErrorBoundary> {
  ...
  Future<void> _initialize() async {
    ...
    try {
      ...
      debugPrint('[GlobalErrorBoundary] Logger init failed: $e');
    }
...
class DeepLinkingService {
  ...
  void _processInvite(String ref) {
    _logger.d('Processing invite: $ref');
    final context = _navigatorKey.currentContext;
    if (context == null) {
      Future.delayed(const Duration(milliseconds: 500), () => _processInvite(ref));
      return;
    }
    GoRouter.of(context).go('/invite/$ref');
  }

  void _processPasswordReset(String token) {
    _logger.d('Processing password reset');
    final context = _navigatorKey.currentContext;
    if (context == null) {
      Future.delayed(const Duration(milliseconds: 500), () => _processPasswordReset(token));
      return;
    }
    GoRouter.of(context).go('/reset-password', extra: {'token': token});
  }

  void _processEmailVerification(String token) {
    _logger.d('Processing email verification');
    final context = _navigatorKey.currentContext;
    if (context == null) {
      Future.delayed(const Duration(milliseconds: 500), () => _processEmailVerification(token));
      return;
    }
...
class StreamingChatNotifier extends StateNotifier<StreamingChatState> {
  ...
  Future<void> stopGeneration() async {
    ...
    try {
      ...
      _logger.i('[Chat] Generation stopped by user for message: $msgId');
  ...
  Future<void> _saveMessageToDatabase(ChatMessage message, String sessionId) async {
    try {
      ...
      try {
        ...
        _logger.e('[E2EE] Encrypt failed — saving with plaintext fallback', error: encErr);
        ...
        for (var session in sessions) {
          ...
          final chatMessages = await Future.wait(messages.map((m) async {
            ...
            try {
              ...
              if (decryptedText == '[E2EE_DECRYPT_FAILED]') {
...
class VoiceNotifier extends StateNotifier<VoiceState> {
  ...
  Future<void> _processVoiceCommand(String text, String? sessionId) async {
    try {
      ...
      _logger.d('Voice command processed: "$recognizedText" (type: $commandType)');
  ...
  Future<void> speakText(String text) async {
    ...
    if (isRecording) {
      ...
      _logger.d('TTS queued — recording active');
      return;
    }
    await _executeTts(text);
  }

  Future<void> _executeTts(String text) async {
    try {
      ...
      await _tts.speak(text).timeout(const Duration(seconds: 30), onTimeout: () {
        _tts.stop();
        throw Exception('TTS timeout');
      });
      await _tts.awaitSpeakCompletion(true);
      state = const VoiceState.idle();
      _logger.d('Text spoken: "${text.substring(0, min(50, text.length))}..."');
    } catch (e, stack) {
      _logger.e('Speak text failed', error: e, stackTrace: stack);
      state = const VoiceState.idle();
    } finally {
      if (_isTtsPending && _pendingTtsText != null) {
        final pending = _pendingTtsText!;
